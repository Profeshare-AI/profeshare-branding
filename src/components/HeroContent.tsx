...
const HeroContent = () => {
  return <div className="flex flex-col items-center text-center px-4 relative z-10 lg:pb-4">
      <HeroChip />
      ...
      <p className="lg:hidden font-body text-hero-text text-base md:text-lg leading-relaxed mb-6 w-full opacity-90">
