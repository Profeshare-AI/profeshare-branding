...
const PersonasSection = () => {
  ...
  const renderCard = (item: typeof masonryItems[0]) => {
    ...
    const baseCardClasses = hasImage 
      ? "h-[320px] lg:h-[400px] w-full text-white rounded-2xl p-4 flex flex-col justify-between shadow-lg transition-colors duration-300 overflow-hidden cursor-pointer"
      : "h-[320px] lg:h-[400px] w-full text-white rounded-2xl p-4 flex flex-col justify-between shadow-lg transition-colors duration-300 overflow-hidden cursor-pointer border border-white/10";
