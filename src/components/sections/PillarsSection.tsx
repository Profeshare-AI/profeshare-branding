            ...
            {mobileFeatures.map((row, rowIndex) => (
              <div key={rowIndex} className="flex flex-wrap justify-center gap-3">
                {row.map((feature, index) => (
                  <div key={index} className={`relative inline-flex items-center px-4 py-2 rounded-full backdrop-blur-md bg-white/10 border ${feature.border} text-white text-xs font-body font-medium shadow-lg overflow-hidden`}>
