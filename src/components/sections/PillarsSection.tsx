  ...
  const renderChip = (feature: any, index: number) => {
    ...
    return (
      <div key={index} className="relative">
        ...
        <div className={`relative p-[1px] rounded-full bg-gradient-to-r ${feature.color} shadow-lg transition-all duration-300 group-hover:opacity-0 group cursor-pointer`}>
        ...
        {personaContent && (
          /* Hover area that covers the full card size */
          <div className="absolute inset-0 group-hover:inset-[-96px_-96px_-128px_-96px] transition-all duration-300 pointer-events-none group-hover:pointer-events-auto">
