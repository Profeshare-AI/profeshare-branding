      ...
      <div className="grid lg:grid-cols-4 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-6 w-full">
          {steps.map((step, index) => (
            <GlassCard key={index} className="flex flex-col justify-start min-h-[320px] w-full p-6 hover:bg-white/5 hover:shadow-lg transition-all duration-700 ease-in-out">
