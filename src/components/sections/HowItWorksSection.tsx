...
const steps = [
  {
    ...
    description: "Ask in plain language. \br We understand you better in any way! Example: Find me a Product design internship in Bengaluru with Figma and UX research."
  },
  {
    icon: Search,
