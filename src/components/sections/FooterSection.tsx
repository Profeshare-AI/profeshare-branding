    ...
    <footer className="bg-black/90 py-16 border-t border-white/20">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="lg:hidden">
          {/* First row - Logo and Tagline */}
          <div className="flex flex-col justify-between items-center mb-8 text-center">
          ...
          {/* Third row - Copyright and Privacy */}
          <div className="flex flex-col justify-center items-center pt-6 border-t border-white/20 gap-4 text-center">
            <p className="font-body text-white/60 text-sm">
              © 2025 Profeshare AI. All rights reserved.
            </p>
            <div className="flex gap-4">
